...
def save(city, community, location, total_price, unit_price, layout, area, floor, house_type, release_time, title):
    if not os.path.exists(path):
        os.mkdir(path)
    with open(path + '一线城市二手房.csv', 'a', encoding='utf-8', newline='') as f:
        writer = csv.writer(f)
...
# 构造url
async def main():
    city_urls=['https://su.lianjia.com/','https://bj.lianjia.com/','https://sh.lianjia.com/','https://nj.lianjia.com/','https://cd.lianjia.com/']
    url_list = []
